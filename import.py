...
data = csv.reader(open("static/csv_files/Flange2with35.csv"), delimiter=";")
for row in data:
    if row[0] != 'п»їDN':
...
data = csv.reader(open("static/csv_files/Flange11.csv"), delimiter=";")
for row in data:
...
data = csv.reader(open("static/csv_files/Flange13.csv"), delimiter=";")
for row in data:
    if row[0] != 'п»їDN':
        flange = Flange13()
        flange.pipe_diam = row[0]
...
data = csv.reader(open("static/csv_files/Angle90.csv"), delimiter=";")
for row in data:
    if row[0] != 'п»їxuy':
        angle = Angle90()
...
data = csv.reader(open("static/csv_files/Angle180.csv"), delimiter=";")
for row in data:
    if row[0] != 'п»їDN':
        angle = Angle180()
        angle.pipe_diam = row[0]
...
data = csv.reader(open("static/csv_files/TPieceReducerDIN.csv"), delimiter=";")
for row in data:
    if row[0] != 'п»їDN Big':
...
data = csv.reader(open("static/csv_files/TPiece.DIN.csv"), delimiter=";")
for row in data:
    if row[0] != 'п»їDN ':
        piece = TPieceDIN()
...
data = csv.reader(open("static/csv_files/Reducer.DIN.csv"), delimiter=";")
for row in data:
    if row[0] != 'п»їDN Big':
        reducer = ReducerDIN()
...
data = csv.reader(open("static/csv_files/Caps.csv"), delimiter=";")
for row in data:
    if row[0] != 'п»їDN':
        cap = Caps()
        cap.pipe_diam = row[0]
...
data = csv.reader(open("static/csv_files/reducers.ready.csv"), delimiter=";")
for row in data:
...
data = csv.reader(open("static/csv_files/tpieces_ready.csv"), delimiter=";")
for row in data:
...
data = csv.reader(open("static/csv_files/treducerpieces.ready.csv"), delimiter=";")
for row in data:
...
data = csv.reader(open("static/csv_files/valves.ready.csv"), delimiter=";")
for row in data:
    if row[0] != 'п»їPipediameter in inches':
        valve = Valve()
...
data = csv.reader(open("static/csv_files/insertflanges.ready.csv"), delimiter=";")
for row in data:
    if row[0] != 'п»їPipediameter in inches':
...
data = csv.reader(open("static/csv_files/weldingbends.notready.csv"), delimiter=";")
for row in data:
    if row[0] != 'п»їPipediameter in inches':
...
data = csv.reader(open("static/csv_files/weldingneckflangesASAASTM.maybeready.csv"), delimiter=";")
for row in data:
    if row[0] != 'п»їPipediameter in inches':
...
data = csv.reader(open("static/csv_files/weldolet.csv"), delimiter=";")
for row in data:
...
data = csv.reader(open("static/csv_files/weldingneckflangesDIM.csv"), delimiter=";")
for row in data:
